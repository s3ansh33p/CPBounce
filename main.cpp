...
#ifndef PC
	APP_NAME("Bounce Game Test")
	APP_DESCRIPTION("Bounce Game Test using Ponggers 2 Base Game")
...
void main2() {
	...
	for (int i = 0; i < 100; i+=5) {
		...
		draw_font_shader(f_7x8, "Bounce", 16, 128, color(255, 60, 0), 0, 0, 4, color(122, 222, 222));
		LCD_Refresh();
	}
	...
	for (int i = 0; i < 30; i+=2) {
		...
		draw_font_shader(f_7x8, "Bounce", 16, 248, color(50, 45, 45), 0, 0, 3, i);
		LCD_Refresh();
	}
}
